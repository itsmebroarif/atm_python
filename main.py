...
def ambil_uang(uang):
 ...
 # Sistem Login Ke Akun
 
while pakai_atm == "y":
    while not status_login:
        print("SELAMAT DATANG DI MONEYSAVER.COM")
        print("Developed By Arif Alexander")
 ...
 # Menu Utama Didalemnya
    while loop == "y" and status_login:
        u = users[cek_user(user_id)]
        print("SELAMAT DATANG DI ATM MONEYSAVER.COM")
        print("Developed By Arif Alexander")
        print("1.Cek Saldo")
